      ...
      body: Center(
        child: RaisedButton(
          ...
          onPressed: () {
            ...
            FlutterBoost.singleton.open("second", urlParams: {}, exts: {}).then((Map value) {
              print(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: RaisedButton(
          onPressed: () {
            FlutterBoost.singleton.open("second", urlParams: {}, exts: {});
          },
          child: Text('Open second route'),
        ),
      ),
...
//                Expanded(child: Container()),
                ...
                InkWell(
                  ...
                  onTap: () => FlutterBoost.singleton
                      .open("sample://nativePage", urlParams: {"query": {"aaa": "bbb"}}, exts: {}),
                ),
                InkWell(
                  child: Container(
                      padding: const EdgeInsets.all(8.0),
                  ...
                  ///例如：sample://nativePage?aaa=bbb
                  onTap: () => FlutterBoost.singleton
                      .open("first", urlParams: {"query": {"aaa": "bbb"}}, exts: {}),
                ),
                InkWell(
                  child: Container(
                      padding: const EdgeInsets.all(8.0),
              ...
              InkWell(
                ...
                InkWell(
                  ...
                  onTap: () => FlutterBoost.singleton
                      .open("sample://flutterFragmentPage", urlParams: {}, exts: {}),
                ),
              ],
            ),
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          InkWell(
            ...
            onTap: () => FlutterBoost.singleton.open("sample://nativePage", urlParams: {}, exts: {}),
          ),
          InkWell(
            child: Container(
                padding: const EdgeInsets.all(8.0),
            ...
            onTap: () => FlutterBoost.singleton.open("sample://flutterPage", urlParams: {}, exts: {}),
          ),
          InkWell(
            child: Container(
                padding: const EdgeInsets.all(8.0),
            ...
            onTap: () =>
                FlutterBoost.singleton.open("sample://flutterFragmentPage", urlParams: {}, exts: {}),
          )
        ],
      ),
    );
